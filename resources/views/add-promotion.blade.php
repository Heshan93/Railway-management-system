...
<div class="container-fluid" >
    ...
    <form action="{{route('create-promotion') }}" method="POST">
        @csrf
    ...
    <div class="mb-3">
            ...
            <input type="number" class="form-control" id="promo_value" name="promo_value" min="0">
    </div>
    <div class="mb-3">
            <label for="" class="form-label">Bookings Count</label>
            <input type="number" class="form-control"  name="bookings" min="0">
    </div>
    <div class="mb-3">
